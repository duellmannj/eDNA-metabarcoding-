...
\urlstyle{same}
\hypersetup{
  pdftitle={Using environmental DNA (eDNA) to identify suitable habitat for freshwater mussels in the James River watershed},
  pdfauthor={Nicholas Duellman1 \& },
  pdflang={en-EN},
  pdfkeywords={keywords},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Using environmental DNA (eDNA) to identify suitable habitat for freshwater mussels in the James River watershed}
\author{Nicholas Duellman\textsuperscript{1} \& \textsuperscript{}}
\date{}
...
The authors made the following contributions. Nicholas Duellman: Conceptualization, Writing - Original Draft Preparation, Writing - Review \& Editing; : Writing - Review \& Editing, Supervision.

Correspondence concerning this article should be addressed to Nicholas Duellman, Postal address. E-mail: \href{mailto:my@email.com}{\nolinkurl{my@email.com}}

}

\affiliation{\vspace{0.5cm}\textsuperscript{1} Longwood University\\\textsuperscript{2} Cook - Cole College of Science}
...
We used R (Version 4.4.2; R Core Team, 2024) and the R-packages \emph{papaja} (Version 0.1.3; Aust \& Barth, 2024) and \emph{tinylabels} (Version 0.2.4; Barth, 2023) for all our analyses.
